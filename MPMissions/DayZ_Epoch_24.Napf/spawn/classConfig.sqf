...
_startBag = "DZ_ALICE_Pack_EP1"; // Use "" for none
_startMags = ["ItemBandage",3,"ItemPainkiller","ItemWaterbottle","FoodPistachio","17Rnd_9x19_glock17",3];
_startWeps = ["ItemMap","ItemFlashlight","ItemToolbox","glock17_EP1","ItemRadio"];
_customLoadout = [
...
_classLevel1 = ["0","0","0"];
_classLevel2 = ["0","0","0"];
_classLevel3 = ["76561198134262401","76561198121993182","76561198167901170","76561198181794941"];
